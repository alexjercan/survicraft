...
use survicraft_common::player::{apply_character_action, CharacterPhysicsBundle, CharacterQuery};
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Update, (handle_spawn_player, handle_player_actions).in_set(PlayerPluginSet));
    }
}
