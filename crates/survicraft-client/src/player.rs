...
use survicraft_common::player::{apply_character_action, CharacterPhysicsBundle, CharacterQuery, CHARACTER_CAPSULE_HEIGHT, CHARACTER_CAPSULE_RADIUS};
use survicraft_protocol::{component::PlayerId, input::CharacterAction};
...
fn handle_spawn_player(
    ...
    mut q_player: Query<(Entity, Has<Controlled>), (Added<Replicated>, With<PlayerId>)>,
